      ...
      <section>
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-8">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="mt-8 space-y-6">
                ...
                <div>
                  <h4 className="text-red-700 font-semibold">Call us</h4>
                  <a
                ...
                <div>
                  <h4 className="text-red-700 font-semibold">Email</h4>
                  <a
        ...
        <div className="py-12 px-6 bg-zinc-900 text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <h3 className="text-xl font-semibold text-center text-red-700 my-4">
              Contact Information
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="bg-red-700 text-white font-semibold py-3 px-6 rounded-md mt-4 hover:bg-red-600"
                >
                  Send Message
                </button>
              </div>
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 bg-zinc-950 text-center p-6">
            <h2 className="text-red-500 text-lg font-mono font-semibold">
              NEWSLETTER
            </h2>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center">
              ...
              />
              <button className="px-5 py-2 bg-red-700 text-white font-semibold rounded-md hover:bg-red-600">
                Subscribe
              </button>
            </div>
